...
export function create_timeline(timeline){
    ...
    let order = [13, 45, 21, 48, 34, 53, 55, 49, 44, 46, 51, 52];
    ...
    for(let i=2; i<N; i++){
        ...
        timeline.push({
            ...
            questions: [
                {
                    prompt: "How difficult or easy did you find this puzzle?",
                    name: 'difficulty',
                    labels: [1,2,3,4,5,6,7]
                },
                {
                    prompt: "How confident are you that your move was the best move?",
                    name: 'confidence',
                    labels: [1,2,3,4,5,6,7]
                }
            ],
            button_label: 'Submit',
            on_finish: (data) => {
                let difficulty = data.response.difficulty;
                let confidence = data.response.difficulty;
                puzzles_results[current_trail]['difficulty'] = difficulty;
