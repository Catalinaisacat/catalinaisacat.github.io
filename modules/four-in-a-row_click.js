var jsPsychFourInARow = (function (jspsych) {
    ...
    class FourInARow {
        ...
        //     this.draw_board(click_x - this.rect_left, click_y - this.rect_top);
        // }
        //touchstartEventHandler = ({ clientX: click_x, clientY: click_y }) => {
            ...
            if (!this.white_pieces.includes(piece) && !this.black_pieces.includes(piece)){
                ...
                if (!this.free_play){
                    ...
                    if (this.submit_mode && !this.ready_to_submit) {
                        ...
                        this.draw_board(click_x - this.rect_left, click_y - this.rect_top);
                        this.cvs.removeEventListener("mousemove", this.mouseMoveEventHandler);
                        this.cvs.removeEventListener("mousedown", this.touchstartEventHandler);
                        //this.cvs.removeEventListener("mousedown", this.mouseDownEventHandler);
                        setTimeout(()=>{
                            this.end_trial();
                        },3000);
        ...
        stop_recording(){
            ...
            this.cvs.removeEventListener("mouseup", this.touchendEventHandler);
        ...
        //         // Wait for the 'download' event to be fired on the link.
        ...
        reset_pieces(trial){
            ...
            if (!this.free_play){
                if (this.tree[this.current_state] == -1){
                    ...
                    this.cvs.addEventListener("mousedown", this.touchstartEventHandler);
                    this.cvs.addEventListener("mouseup", () => {this.click_mode = "nothing";this.draw_board(click_x - this.rect_left, click_y - this.rect_top)});
        ...
        update_top(){
            if (this.game_result == "win"){
                ...
                this.top.innerHTML = `You are playing <u>${this.turn}</u> <br/><br/>Plan the best move and say everything that goes through your mind  .`;//, Puzzle ${this.game_index}
            }
        }
        timer(time){
        ...
        trial(display_element, trial){
            ...
            let tp = '<h2 id=\'top\'> You are playing <u>' + this.turn.toString() + '</u> <br/><br/> Plan the best move and say everything that goes through your mind </h1>';
            if (this.warm_up){
            ...
            if (this.free_click){
                ...
                tp = '<h2 id=\'top\'>Let\'s interact with the board now</h1>'
            }
            else {
            ...
            this.cvs.addEventListener("mousedown", this.touchstartEventHandler);
            this.cvs.addEventListener("mouseup", this.touchendEventHandler);
            // Draw board
            this.draw_board(null, null)
            if (this.free_click){
